    ...
    <!-- Parte central de la pagina --> 
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Registro de una Nueva Comunidad</h1>
          </div>
         <main role="main">
          <div class="container">
                      <div class="btn-group">
                  ...
                  <br/><br/>
<form class="needs-validation" novalidate action="../../Controladores/Comunidad/registro-comunidad-controlador.php" method="post">
  <div class="form-row">
      <div class="col-md-4 mb-4">
      <label for="validationTooltip05">Rif</label>
      <input type="text" class="form-control" id="validationTooltip05" name="rif" placeholder="Rif" required>
      <div class="invalid-tooltip">
        Please Introduzca Cedula.
      </div>
    </div>
    <div class="col-md-4 mb-4">
      <label for="validationTooltip01">Nombre de la Comunidad</label>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-4">
      <label for="validationTooltip04">Municipio</label>
      <input type="text" class="form-control" id="validationTooltip04" name="municipio" placeholder="Municipio" required>
      <div class="invalid-tooltip">
        Por favor Introduzca un Telefono Valido.
      </div>
    </div>
    <div class="col-md-4 mb-4">
      <label for="validationTooltip03">Parroquia</label>
      <input type="text" class="form-control" id="validationTooltip03"  name="parroquia" placeholder="Parroquia" required>
      <div class="invalid-tooltip">
