    ...
    <!-- Parte central de la pagina --> 
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Registro de Programa</h1>
          </div>
         <main role="main">
          <div class="container">
                      <div class="btn-group">
                  ...
                  <br/><br/>
<form class="needs-validation" novalidate action="../../Controladores/Programa/registro-programa-controlador.php" method="post">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-4">
      ...
      <input type="text" class="form-control" id="validationTooltip01" name="descripcion" placeholder="Descripcion"  required>
      <div class="valid-tooltip">
        Looks good!
      </div>
    </div>
    <div class="col-md-4 mb-4">
      <label for="validationTooltip02">Siglas</label>
      <input type="text" class="form-control" id="validationTooltip02" name="siglas" placeholder="Siglas: Ejemplo PNF" required>
      <div class="valid-tooltip">
        Looks good!
      </div>
    </div>
