...
foreach ($r1 as $valor) {
  if (isset($valor["nombre"])) {
    ...
    $impr .= '
    <td>
      <form action="../Usuario/cargar-usuario-controlador.php" method="POST">
               <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
      ...
      <form action="../Usuario/eliminar-usuario-controlador.php" method="POST">
               <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
        <input class="d-flex justify-content-between align-items-center" type="hidden" name="cedula" value="'.$valor['cedula'].'" />
