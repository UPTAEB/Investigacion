    ...
    <!-- Parte central de la pagina --> 
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Registro Linea de Investigacion</h1>
          </div>
         <main role="main">
          <div class="container">
                      <div class="btn-group">
                  ...
                  <br/><br/>
<form class="needs-validation" novalidate action="../../Controladores/Linea_de_Investigacion/registro-controlador.php" method="post">
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      <label for="validationTooltip02">PNF</label>
      <select class="form-control" id="id_programa" name="id_programa">
        <option value="0">Seleccione PNF</option>
        <?php 
        foreach ($rsPNF as $valor){
          if($valor['id_programa']!=null) 
             echo '<option value = "'.$valor['id_programa'].'">'.$valor['siglas'].'</option>';
        }
        ?>
    </select>
      <div class="valid-tooltip">
