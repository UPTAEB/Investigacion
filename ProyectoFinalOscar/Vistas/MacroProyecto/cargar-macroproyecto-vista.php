         ...
         <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                       <a  class="btn btn-sm btn-primary" href="../../Controladores/inicio/index-consultar-controlador.php">Volver</a>
                                        ...
                                        <div class="btn-group">
                       <a  class="btn btn-sm btn-primary" href="../../Controladores/Proyecto/consultar-controlador.php">Ver todos los Proyectos</a>
                    </div>
                  </div>
                  <br/>
...
foreach ($r1 as $valor) {
  if (isset($valor["nombre"])) {
    ...
    $impr .= '
    <td>
      <form action="../Macroproyecto/cargar-macroproyecto-controlador.php" method="POST">
       <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
      ...
      <form action="../Macroproyecto/eliminar-macroproyecto-controlador.php" method="POST">
       <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
        <input type="hidden" name="nombre" value="'.$valor['nombre'].'" />
