...
foreach ($r1 as $valor) {
    if (isset($valor["rif"])) {
        ...
        $impr .= '
        <td>
      <form action="../Comunidad/cargar-comunidad-controlador.php" method="POST">
               <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
      ...
      <form action="../Comunidad/eliminar-comunidad-controlador.php" method="POST">
               <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
        <input class="d-flex justify-content-between align-items-center" type="hidden" name="rif" value="'.$valor['rif'].'" />
