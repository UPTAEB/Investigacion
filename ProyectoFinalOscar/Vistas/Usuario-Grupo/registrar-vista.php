    ...
    <!-- Parte central de la pagina --> 
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Afiliar Usuario a un Grupo</h1>
          </div>
         <main role="main">
          <div class="container">
                      <div class="btn-group">
                  ...
                  <br/><br/>
<form class="needs-validation" novalidate action="../../Controladores/Usuario-Grupo/registrar-controlador.php" method="post">
  <div class="form-row">
      <div class="col-md-4 mb-4">
      <label for="validationTooltip05">Usuario</label>
      <select class="form-control" id="validationTooltip05" name="id_usuario" required/>
        <option></option>
        <?php 
        foreach ($rsUsuario as $valor){
          if($valor['id_usuario']!=null) 
             echo '<option value = "'.$valor['id_usuario'].'">'.$valor['cedula'].'-'.$valor['nombre'].'</option>';
        }
        ?>
    </select>
      </div>
      <div class="col-md-4 mb-4">
      <label for="validationTooltip01">Grupo de Investigacion</label>
      <select class="form-control" id="validationTooltip01"  name="id_grupo" required/>
        <option></option>
        <?php 
    ...
    <div class="col-md-4 mb-4">
      <label for="validationTooltip02">Fecha de Afiliacion</label>
      <input type="date" class="form-control" id="validationTooltip02" name="fecha_afiliacion" required>
